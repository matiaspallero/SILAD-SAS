      ...
      <div className="bg-white shadow-2xl w-full max-w-3xl flex flex-col max-h-full">
        ...
        <div className="bg-slate-100 px-6 py-3 border-b border-slate-200 flex justify-between items-center print:hidden">
          ...
          <div className="flex space-x-3">
            <button onClick={onClose} className="px-4 py-2 bg-white border border-slate-300 rounded text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
              Cerrar
            </button>
            <button 
              onClick={() => window.print()}
              className="px-4 py-2 bg-blue-600 rounded text-sm font-medium text-white hover:bg-blue-700 transition-colors flex items-center"
            >
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <form onSubmit={handleCloseWork} className="space-y-6">
          ...
          <div className="flex justify-end p-6 bg-slate-900 rounded-xl shadow-lg">
            <button 
              type="submit"
              className={`px-8 py-3 rounded-lg font-bold text-white transition-colors shadow-sm flex items-center
